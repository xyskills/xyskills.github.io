...
void main() {
  float noise1 = snoise(vPosition * 4.0 + uTime * 1.2) * 0.5 + 0.5;
  float noise2 = snoise(vPosition * 8.0 - uTime * 1.8) * 0.5 + 0.5;
  ...
  vec3 coreColor = uColor * (0.6 + noise1 * 0.6) * voidMask;
  vec3 rimGlow = uGlowColor * fresnel * (1.5 + noise2 * 0.8) * uIntensity;
  vec3 detail = uGlowColor * noise3 * 0.3 * fresnel;
