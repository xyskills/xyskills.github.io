...
uniform float uVideoAspect;\r
uniform float uScreenAspect;\r
...
void main() {\r
  ...
  float ratio = uVideoAspect / uScreenAspect;\r
  vec2 uv = vUv;\r
  if (ratio > 1.0) {\r
    
    uv.x = (uv.x - 0.5) / ratio + 0.5;\r
  } else {\r
    
    uv.y = (uv.y - 0.5) * ratio + 0.5;\r
  }
